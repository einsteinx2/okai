      ...
      hlnkWebsite (0)
{
    ...
    addAndMakeVisible (hlnkWebsite = new HyperlinkButton (T("website"),
                                                          URL (T("http://okai.movsq.net"))));
    hlnkWebsite->setTooltip (T("http://okai.movsq.net"));
    hlnkWebsite->setColour (HyperlinkButton::textColourId, Colour (0xcc000000));
...
{
    cmbModes->setBounds (getWidth() - 132, 8, 120, 24);
    lstServers->setBounds (88, 112, getWidth() - 98, getHeight() - 122);
    btnAdd->setBounds (8, getHeight() - 82, 80, 24);
    btnEdit->setBounds (8, getHeight() - 58, 80, 24);
    btnDelete->setBounds (8, getHeight() - 34, 80, 24);
    txtNick->setBounds (88, 16, 150, 24);
    label->setBounds (8, 16, 72, 24);
    label2->setBounds (8, 48, 72, 24);
    cmbConnection->setBounds (88, 48, 150, 24);
    txtIP->setBounds (88, 80, getWidth() - 338, 24);
    label3->setBounds (8, 80, 72, 24);
    label4->setBounds (8, 112, 72, 24);
    btnConnect->setBounds (getWidth() - 250, 80, 72, 24);
    btnPing->setBounds (getWidth() - 180, 80, 72, 24);
    btnMastersList->setBounds (getWidth() - 110, 80, 95, 24);
    hlnkWebsite->setBounds (500, 45, 50, 20);
    internalPath1.clear();
    ...
    internalPath1.quadraticTo ((float) (-26), 257.0f, (float) (-19), 256.0f);
    ...
    internalPath1.quadraticTo (184.0f, 19.0f, 182.0f, 19.0f);
    ...
    internalPath1.quadraticTo (140.0f, 146.0f, 150.0f, 146.0f);
...
<JUCER_COMPONENT documentType="Component" className="juceKailleraServerSelect"
  ...
  <COMBOBOX name="new combo box" id="49c69771b5e49450" memberName="cmbModes"
            virtualName="" explicitFocusOrder="0" pos="132R 8 120 24" editable="0"
  ...
  <GENERICCOMPONENT name="new component" id="24fcc1cb902187fd" memberName="lstServers"
                    virtualName="" explicitFocusOrder="0" pos="88 112 98M 122M" class="TableListBox"
                    params="T(&quot;serversList&quot;), &amp;serversListModel"/>
  <TEXTBUTTON name="new button" id="7820dfae9523cee6" memberName="btnAdd" virtualName=""
              explicitFocusOrder="0" pos="8 82R 80 24" bgColOff="ffbbbbff"
  ...
  <TEXTBUTTON name="new button" id="38bc363dbffd9a1d" memberName="btnEdit"
              virtualName="" explicitFocusOrder="0" pos="8 58R 80 24" bgColOff="ffbbbbff"
  ...
  <TEXTBUTTON name="new button" id="17e3c0b7c04af57d" memberName="btnDelete"
              virtualName="" explicitFocusOrder="0" pos="8 34R 80 24" bgColOff="ffbbbbff"
  ...
  <TEXTEDITOR name="new text editor" id="f728b2b0d08a866d" memberName="txtIP"
              virtualName="" explicitFocusOrder="0" pos="88 80 338M 24" bkgcol="ffffffff"
              initialText="" multiline="0" retKeyStartsLine="0" readonly="0"
              scrollbars="1" caret="1" popupmenu="1"/>
  ...
  <TEXTBUTTON name="new button" id="338911b955ce9e7b" memberName="btnConnect"
              virtualName="" explicitFocusOrder="0" pos="250R 80 72 24" bgColOff="ffbbbbff"
  ...
  <TEXTBUTTON name="new button" id="68732a1e64ca5d16" memberName="btnPing"
              virtualName="" explicitFocusOrder="0" pos="180R 80 72 24" bgColOff="ffbbbbff"
  ...
  <TEXTBUTTON name="new button" id="b87b3e9343f1e548" memberName="btnMastersList"
              virtualName="" explicitFocusOrder="0" pos="110R 80 95 24" buttonText="master list"
              connectedEdges="1" needsCallback="1" radioGroupId="0"/>
  <HYPERLINKBUTTON name="new hyperlink" id="ceb618b4d6d2ad11" memberName="hlnkWebsite"
                   virtualName="" explicitFocusOrder="0" pos="500 45 50 20" tooltip="http://okai.movsq.net"
                   textCol="cc000000" buttonText="website" connectedEdges="0" needsCallback="0"
                   radioGroupId="0" url="http://okai.movsq.net"/>
</JUCER_COMPONENT>
